    ...
    constructor() {
        ...
        if (!host) {
            ...
            if (host === "windows" || host === "mac" || host === "linux" || host === "linux_arm64") {
                ...
                throw TypeError(`host: "${host}" is not one of "windows" | "mac" | "linux" | "linux_arm64"`);
            }
        }
        ...
        if (this.host === "linux_arm64") {
            ...
            if (!compareVersions(version, ">=", "6.7.0")) {
                throw TypeError(`version: "${version}" must be greater than or equal to "6.7.0" for Linux ARM64 builds`);
            }
        }
